    ...
    <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
        <div class="blog-item bg-light rounded overflow-hidden">
            <div class="blog-img position-relative overflow-hidden">
                <img class="img-fluid" src="{{ file_exists(public_path('storage/images/posts/' . $post->id . '.jpg')) ? url('storage/images/posts/' . $post->id . '.jpg') : 'https://icon-library.com/images/no-image-icon/no-image-icon-0.jpg' }}" alt="">
