...
@section('content')
  <div class="mb-5">
    ...
    @else
      <img src="{{ file_exists(public_path('storage/images/posts/' . $post->id . '.jpg')) ? url('storage/images/posts/' . $post->id . '.jpg') : url('storage/images/posts/example.jpg') }}" class="img-fluid mt-3" alt="{{ $post->category->name }}">
    @endif
    <h1>{{ $post->title }}</h1>
